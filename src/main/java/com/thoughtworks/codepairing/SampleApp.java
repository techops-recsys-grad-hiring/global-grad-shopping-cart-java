...
public class SampleApp {
    public static void main(String[] args) {
        Product product1 = new Product(BigDecimal.valueOf(10), "DIS_10_PRODUCT1", "product 1");
        Product product2 = new Product(BigDecimal.valueOf(20), "DIS_10_PRODUCT2", "product 2");
        ...
        Product product3 = new Product(BigDecimal.valueOf(30), "DIS_10_PRODUCT3", "product 3");
